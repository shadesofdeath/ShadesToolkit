...
echo  ====================================
echo.
echo   [1] Add Windows Settings shortcut to the Context Menu
echo.
echo   [2] Add new BATCH file shortcut to the Context Menu
echo.
echo   [3] Add new VBScript file shortcut to the Context Menu
echo.
echo   [4] Add Explorer restart shortcut to the Context Menu
echo.
echo   [5] Add shortcut to empty the Recycle Bin to the Context Menu
echo.
echo   [6] Add Take Ownership shortcut to the Context Menu
echo.
echo.
echo   [Z] Geri
echo   [X] Çıkış
...
if /i "%choice%"=="y" (
   ...
   echo ► Invalid choice. Please select either y or n key.
)
goto menu
goto menu
