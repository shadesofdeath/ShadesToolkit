...
Bin\MinSudo --TrustedInstaller --Verbose cmd /c "xcopy /Y /E Bin\DefaultLayouts.xml Mount\Install\Windows\WinSxS\amd64_microsoft-windows-ui-pcshell_31bf3856ad364e35_10.0.22621.1_none_76348001aa8d6a7f"
Bin\MinSudo --TrustedInstaller --Verbose cmd /c "xcopy /Y /E Bin\LayoutModification.xml Mount\Install\Windows\WinSxS\amd64_microsoft-windows-ui-pcshell_31bf3856ad364e35_10.0.22621.1_none_76348001aa8d6a7f"
Bin\MinSudo --TrustedInstaller --Verbose cmd /c "xcopy /Y /E Bin\LayoutModification.json Mount\Install\Windows\WinSxS\amd64_microsoft-windows-ui-pcshell_31bf3856ad364e35_10.0.22621.1_none_76348001aa8d6a7f"
echo.
pause
goto customize
...
cls
echo.
set /p iso_path=ISO dosyasının yolunu giriniz: 

if not exist %iso_path% (
  echo Belirtilen dosya yolunda bir ISO dosyası bulunamadı..
  pause
  goto iso_extract
)
...
cls
echo.
echo ISO dosyası "Extracted" klasörü içerisine başarıyla çıkartıldı.
pause
goto menu
